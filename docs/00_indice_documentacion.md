# Índice de documentación - VigilData

## Documentos incluidos

| Documento | Propósito |
|-----------|-----------|
| `01_vision_y_alcance.md` | Define la visión del producto, problema, usuarios y alcance funcional. |
| `02_product_backlog.md` | Consolida el backlog de historias de usuario trabajado en Taiga. |
| `03_planificacion_sprints.md` | Presenta la planificación de los tres sprints del proyecto. |
...
|--------|--------|----------|
| Sprint 1 | 20/04/2026 - 28/04/2026 | Reportar incidentes y visualizarlos en mapa. |
| Sprint 2 | 29/04/2026 - 05/05/2026 | Incorporar autenticación y filtrado de incidentes. |
| Sprint 3 | 06/05/2026 - 12/05/2026 | Mejorar calidad, confianza y análisis de los reportes. |
